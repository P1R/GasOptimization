...
contract GasContract is Constants {
    ...
    function addToWhitelist(
        ...
        assembly {
            let ptr := mload(0x40) // allocate memory for pointer
            switch _adminIndex
            case 0 {
                mstore(ptr, __administrator0)
            }
            case 1 {
                mstore(ptr, __administrator1)
            }
            case 2 {
                mstore(ptr, __administrator2)
            }
            case 3 {
                mstore(ptr, __administrator3)
            }
            case 4 {
                mstore(ptr, __owner)
            }
            ...
            return(ptr, 0x20) // return pointer
        }
    }
